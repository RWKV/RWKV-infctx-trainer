...
MODEL_CODE_DIR = os.path.join(PROJECT_DIR, 'RWKV-v5')
...
async def main_function():
    ...
    if len(sys.argv) < 2:
        ...
        print("Usage: python3 eval_model_memory.py <rwkv_model_path> [verbose/csv-file-path] [from_token_count] [to_token_count]")
        sys.exit(1)
