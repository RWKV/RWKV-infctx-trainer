...
### ---
# Layer Repeat multiplier env variable, for -LRX experiment
### ---

global RWKV_TMIX_MULTIPLIER, RWKV_CMIX_MULTIPLIER
RWKV_TMIX_MULTIPLIER = int(os.environ.get("RWKV_TMIX_MULTIPLIER", 1))
RWKV_CMIX_MULTIPLIER = int(os.environ.get("RWKV_CMIX_MULTIPLIER", 1))

# Print the layer repeat multiplier
print("====================================================================")
print(f"[RWKV] TimeMix    Layer Repeat Multiplier: {RWKV_TMIX_MULTIPLIER}")
print(f"[RWKV] ChannelMix Layer Repeat Multiplier: {RWKV_CMIX_MULTIPLIER}")
print("====================================================================")
...
class BlockState:
    def __init__(self, tMix_state_list: list[tuple[torch.Tensor,torch.Tensor]],
        ...
        self.cMix_state_list = cMix_state_list
